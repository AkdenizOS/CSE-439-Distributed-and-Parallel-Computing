...
| Person | What is here |
|--------|-------------|
| [mustafa-arinmis](people/mustafa-arinmis/) | Two homeworks and the midterm project |

## Contents

| Folder | What it is |
|--------|-----------|
| `people/mustafa-arinmis/hw1/` | Matrix multiplication with a transposed second matrix to improve cache locality, plus a timing harness (`test.sh`), a plotting script, measured results, and a write-up on spatial locality |
| `people/mustafa-arinmis/hw2/` | *Efficient Calculation of Pi via Multithreading* — a final report with pthreads code, a Taylor series derivation, and a performance plot |
| `people/mustafa-arinmis/midterm/` | Parallel matrix multiplication of 5000×5000 matrices with MS-MPI, loading operands from binary files. Includes a benchmark script, a matrix generator, a speedup/efficiency plot, and the full report |
...
`people/mustafa-arinmis/hw1/` and [`labs/matrix-multiplication/`](../../labs/matrix-multiplication/) look
